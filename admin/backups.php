...
function restoreFromBackup(){
    ...
    copy($_SERVER['DOCUMENT_ROOT'] . $subdir . "/admin/backups/" . $backup_filename, $_SERVER['DOCUMENT_ROOT'] . $subdir . "/pages_text/" . $page_name . ".txt");
    copy($_SERVER['DOCUMENT_ROOT'] . $subdir . "/admin/templates/new_page.php", $_SERVER['DOCUMENT_ROOT'] . $subdir . "/pages/" . $page_name . ".php");
    addToSort($page_name);
}

function addToSort($page_name){
    $json = json_decode(file_get_contents("sorted_pages.txt"), true);
    if (!in_array($page_name, $json)){
        array_push($json, $page_name . ".php");
        file_put_contents("sorted_pages.txt", json_encode($json));
    }
}

function deleteBackup(){
    if (unlink($_SERVER['DOCUMENT_ROOT'] . $subdir . "/admin/backups/" . $_POST['page'])){
...
function clearAllBackups(){
    ...
    foreach ($file_array as $file){
        unlink($_SERVER['DOCUMENT_ROOT'] . $subdir . "/admin/backups/" . $file);
    }
}
